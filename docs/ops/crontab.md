...
# 每日选股推送（工作日 20:30）
30 20 * * 1-5 cd /mnt/data/workspace/stock-monitor-app-py/scripts && python3 -u daily_pick_combined.py --push --wait >> /tmp/daily-pick-combined.log 2>&1
```
...
| 策略 | 脚本 | 触发时间 | 持有规则 |
|------|------|---------|---------|
| **Fstop3_pt5 v10** | daily_pick_combined.py | 工作日 20:30 | 止损3% + 止盈5% |
| BB1.00 | daily_pick_combined.py | 工作日 20:30 | 固定7天 |
| BB0.99 | daily_pick_combined.py | 工作日 20:30 | 固定7天 |
